...
const (
	...
	CodeMasterValidateAllRelationUnsupported diagnostic.Code = "belt.semantic.master_validate_all_relation_unsupported"
	CodeMasterValidateNotAssert              diagnostic.Code = "belt.semantic.master_validate_not_assert"
...
func newMasterValidateAllRelationUnsupportedDiagnostic(offset int, width int, master string) diagnostic.Diagnostic {
	fields := map[string]fmt.Stringer{
		"master": diagnostic.Str(master),
	}
	return diagnostic.Diagnostic{
		Severity: diagnostic.Error,
		Code:     CodeMasterValidateAllRelationUnsupported,
		Message:  diagnostic.Render(diagnostic.DefaultLocale, CodeMasterValidateAllRelationUnsupported, fields),
		Fields:   fields,
		Offset:   offset,
		Width:    width,
	}
...
func newMasterValidateNotAssertDiagnostic(offset int, width int, master string) diagnostic.Diagnostic {
	fields := map[string]fmt.Stringer{
		"master": diagnostic.Str(master),
	}
	return diagnostic.Diagnostic{
		Severity: diagnostic.Error,
		Code:     CodeMasterValidateNotAssert,
		Message:  diagnostic.Render(diagnostic.DefaultLocale, CodeMasterValidateNotAssert, fields),
		Fields:   fields,
		Offset:   offset,
		Width:    width,
	}
