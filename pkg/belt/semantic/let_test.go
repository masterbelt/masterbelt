...
func TestLetEvalFolds(t *testing.T) {
	src := "pub fn pick(flag: bool): nint {\n  let base = 10\n  let result = base\n  if flag {\n    result = base * 2\n  }\n  return result\n}\nconst A = pick(true)\nconst B = pick(false)\n"
...
func TestLetShadowFolds(t *testing.T) {
	src := "pub fn shadow(flag: bool): nint {\n  let result = 1\n  if flag {\n    let result = 2\n    result = result + 10\n    return result\n  }\n  return result\n}\nconst A = shadow(true)\nconst B = shadow(false)\n"
...
func TestLetStaysPure(t *testing.T) {
	_, diags := analyze("pub fn step(n: nint): nint {\n  let acc = n\n  acc = acc + 1\n  return acc\n}\nconst A = step(41)\n")
	if len(diags) != 0 {
