...
type InterfaceMember struct {
	...
	Static     bool         // a static-fn requirement (static Name(): T), called through the type
...
func NewInterfaceMember(doc []string, public bool, name string, readable, static, hasBody bool, typeParams []*TypeParam, params []*ParamDef, result TypeExpr, body []Stmt, syntax *cst.Node) *InterfaceMember {
	return &InterfaceMember{Doc: doc, Public: public, Name: name, Readable: readable, Static: static, HasBody: hasBody, TypeParams: typeParams, Params: params, Result: result, Body: body, syntax: syntax}
}
